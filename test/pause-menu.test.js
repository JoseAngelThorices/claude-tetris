...
const INITIALLY_HIDDEN = ['overlay', 'pause-menu', 'pause-controls', 'record-message', 'name-form', 'gameover-records'];
...
function createEnv(initialStorage = {}) {
  ...
  // Al cargar se muestra la pantalla de inicio: arrancar la partida como el botón Jugar
